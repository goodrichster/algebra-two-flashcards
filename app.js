(function () {
  ...
  var STORAGE_KEY = "goodrichster-algebra-two-flashcards-session";

  var TOPIC_LABELS = {
    "quadratic-basics": "Quadratic basics",
    "forms-of-quadratics": "Forms of quadratics",
    "finding-vertex": "Finding the vertex",
  ...
  var cards = window.ALGEBRA_TWO_CARDS || [];
  ...
  function populateTopics() {
    ...
    ids.forEach(function (id) {
      ...
      opt.value = id;
      opt.textContent = TOPIC_LABELS[id] || id;
...
function sendHeight() {
  ...
  window.parent.postMessage({ type: "algebra-two-flashcards-height", height }, "*");
}
